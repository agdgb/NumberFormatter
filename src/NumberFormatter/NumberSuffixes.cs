...
/// <summary>
/// Provides predefined arrays of <see cref="NumberSuffix"/> instances for different formatting contexts.
/// Arrays are ordered from largest to smallest magnitude for efficient suffix selection.
/// Used internally by <see cref="NumberFormatter"/> for short number formatting.
/// </summary>
internal static class NumberSuffixes
{
    /// <summary>
    /// Default short number suffixes used by <see cref="NumberFormatter"/>.
    ...
    /// </remarks>
    public static readonly NumberSuffix[] Default =
    {
    ...
    /// </summary>
    public static readonly NumberSuffix[] Financial =
    {
    ...
    /// </remarks>
    public static readonly NumberSuffix[] Scientific =
    {
